defmodule TableFormatterTest do
    ...
    alias JulyIssues.TableFormatter, as: TF
    ...
    def split_with_three_columns do
        TF.split_into_columns(@simple_data, @headers)
    end
    ...
    test "correct format if string returned" do
        assert TF.format_for([9,10,11]) == "~-9s | ~-10s | ~-11s~n" 
    end

    test "Output is correct" do
        result =  capture_io fn -> 
            TF.print_table_for_columns(@simple_data, @headers)
        end
